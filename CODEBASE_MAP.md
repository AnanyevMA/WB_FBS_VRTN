...
| [`app/national_catalog/schemas.py`](file:///D:/PyCharm_Projects/WB FBS/app/national_catalog/schemas.py) | `ProductAttributeItem`, `ProductImageItem`, `ProductCardCreateRequest`, `ProductCardUpdateRequest`, `ProductCardResponse`, `PrepareSignResponse`, `SubmitSignRequest`, `SyncNKResponse`, `ProductCardBatchCreateRequest`, `ProductCardBatchResponse`, `BatchGtinResponse` | — | Модуль кодовой базы |
