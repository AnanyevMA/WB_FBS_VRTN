...
> **Дата актуализации**: 2026-08-25 23:01:24 UTC | **Файлов проиндексировано**: 75  
...
| [`app/services/kiz_service.py`](file:///D:/PyCharm_Projects/WB FBS/app/services/kiz_service.py) | — | `is_kiz_withdrawn`, `extract_cz_item_info`, `parse_kiz_code`, `resolve_kiz_product_info` | Модуль кодовой базы |
...
| [`tests/test_kiz_service.py`](file:///D:/PyCharm_Projects/WB FBS/tests/test_kiz_service.py) | — | `test_parse_kiz_code_standard`, `test_parse_kiz_code_with_parentheses`, `test_parse_kiz_code_with_crypto_tail`, `test_kiz_product_info_model_and_validation`, +еще 7 | Модуль кодовой базы |
