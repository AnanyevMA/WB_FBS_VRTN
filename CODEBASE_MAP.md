...
> **Дата актуализации**: 2026-09-02 14:13:21 UTC | **Файлов проиндексировано**: 96  
...
| Файл | Классы / Модели | Функции / Эндпоинты / Таски | Назначение |
|---|---|---|---|
| [`tests/run_adversarial.py`](file:///D:/PyCharm_Projects/WB FBS/tests/run_adversarial.py) | — | — | Модуль кодовой базы |
...
| [`tests/test_order_poller_enrichment.py`](file:///D:/PyCharm_Projects/WB FBS/tests/test_order_poller_enrichment.py) | — | `setup_db`, `test_seller`, `test_resolve_order_metadata_from_local_db_cache_by_chrt_id`, `test_resolve_order_metadata_from_local_db_cache_by_article`, +еще 5 | Модуль кодовой базы |
